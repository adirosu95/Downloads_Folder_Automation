...
def check_directory(parent_dir, dir_name):
    """
    Check if 'dir_path' exists, if not it will create the directory.
    Args:
    ...
    all_directories = (d for d in os.listdir(parent_dir) if os.path.isdir(os.path.join(parent_dir, dir_name)))
